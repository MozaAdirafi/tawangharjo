...
export default function AktaPerceraian() {
  const [activeTab, setActiveTab] = useState('reguler');

  const requirements = {
    common: [
      {
        title: 'Keputusan dari Pengadilan Negeri',
        details: [
      ...
      {
        title: 'Kutipan Akta Perkawinan',
        details: [
          'Dokumen asli harus dibawa/discan',
          'Pemeriksaan kesesuaian data pernikahan'
        ]
      },
      {
        title: 'Kartu Keluarga (KK) dan Kartu Tanda Penduduk (KTP)',
        details: [
      ...
      {
        title: 'Surat Keterangan Perceraian dari Pengadilan',
        details: [
          'Dokumen resmi dari lembaga berwenang',
          'Berisi detail perceraian yang lengkap'
        ]
      },
      {
  ...
  const procedures = {
    reguler: [
      ...
      'Pemohon dapat mengambil dokumen Akta Perceraian.'
    ],
    online: [
      ...
      'Draft Akta Perceraian divalidasi oleh pejabat Disdukcapil.',
      'Kepala Dinas melakukan Tanda Tangan Elektronik (TTE).',
      'Tanda Tangan Elektronik dikirim ke BSrE untuk persetujuan.',
      'Akta Perceraian dapat dicetak setelah tersertifikasi di SIAK.',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        <title>Layanan Akta Perceraian - Desa Tawangharjo</title>
        <meta
          name="description"
          content="Informasi lengkap tentang pembuatan dan pengurusan Akta Perceraian di Desa Tawangharjo"
        />
      </Head>
      ...
      <section className="bg-green-700 text-white py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold text-center mb-4">Layanan Akta Perceraian</h1>
          <p className="text-xl text-center text-green-100">
            Informasi lengkap tentang prosedur dan persyaratan pengurusan Akta Perceraian
          </p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">
              Prosedur Pelayanan Akta Perceraian : <br></br> {activeTab === 'online' ? 'Online' : 'Langsung (Reguler)'}
            </h2>
